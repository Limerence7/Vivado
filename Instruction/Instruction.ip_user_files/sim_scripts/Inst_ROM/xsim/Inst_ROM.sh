...
#
# Generated by Vivado on Sun Jul 16 14:06:56 +0800 2023
...
# Script info
echo -e "Inst_ROM.sh - Script generated by export_simulation (Vivado v2022.2.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L blk_mem_gen_v8_4_5 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Inst_ROM xil_defaultlib.Inst_ROM xil_defaultlib.glbl -log elaborate.log
}
...
{
  file="xsim.ini"
  lib_map_path="D:/IDE/Xilinx/Vivado/2022.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
